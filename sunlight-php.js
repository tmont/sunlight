(function(sunlight, undefined){
	...
	sunlight.registerLanguage(["php"], {
		...
		customTokens: {
			...
			languageConstruct: ["isset", "array", "unset", "list", "echo", "include", "include_once", "require", "require_once", "print", "empty", "return", "die", "eval", "exit"],
			constant: ["__CLASS__", "__DIR__", "__FILE__", "__LINE__", "__FUNCTION__", "__METHOD__", "__NAMESPACE__"]
		},
