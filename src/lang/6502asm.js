...
module.exports = {
	keywords: [
		...
		//regular ops
		'BRK', 'NOP', 'RTI', 'RTS', 'ASL', 'LSR', 'ROL', 'ROR', 'ADC', 'AND', 'BIT',
		'DEC', 'EOR', 'INC', 'JMP', 'JSR', 'LDA', 'LDX', 'LDY', 'ORA', 'SBC', 'STA', 'STX', 'STY',
		//stack ops
	...
	customParseRules: [
		function(context) {
            ...
            //once inside () or [], anything goes, but once outside, terminate with whitespace
		...
		function() {
			...
			return function(context) {
				...
				if (!prevToken || prevToken.name !== 'keyword' || !utils.contains(validLabelOps, prevToken.value, true)) {
