(function(sunlight, undefined){
	...
	sunlight.registerLanguage("bash", {
		...
		scopes: {
			...
			//"switch": [ ["-", { length: 1, regex: /\s/ }, null, true] ]
		},
		...
		namedIdentRules: {
			precedes: [
				[sunlight.util.whitespace, { token: "punctuation", values: ["("] }, sunlight.util.whitespace, { token: "punctuation", values: [")"] }, sunlight.util.whitespace, { token: "punctuation", values: ["{"] } ]
			]
		},
