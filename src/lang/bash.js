...
module.exports = {
	keywords: [
		'while', 'for', 'in', 'do', 'done', 'until', 'if', 'fi', 'then',
		'else', 'case', 'esac', 'break', 'continue', 'select'
	],
	...
	scopes: {
		string: [ scopes.doubleQuotedString, scopes.singleQuotedString ],
		hashBang: [ ['#!', '\n', null, true] ],
		comment: [ scopes.hashComment ],
		verbatimCommand: [ ['`', '`', ['\\`', '\\\\']] ],
